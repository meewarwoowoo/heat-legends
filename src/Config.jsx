...
const Config = (props) => {
    ...
    function setLocalConfigJSON(valueToSet,valueToEdit){
		...
		localStorage.setItem('configJSON',JSON.stringify(workingConfigJSON));
   }
			...
			<main className={props.getMainClassList()}>
				<section className="cnt">
					...
					<div className="ins">
						...
						<ul>
							<li className="switch">
								<label><input type="checkbox" checked={showMoreWhite} onChange={(e) => { setShowMoreWhite(e.currentTarget.checked) ; setLocalConfigJSON(e.currentTarget.checked,'showMoreWhite') }} />
